...
- Signal-based entry level adjustment 
...
Configurations:
    ...
    bb_weak_threshold: The Bollinger Band width threshold for weak trend
    bb_strong_threshold: The Bollinger Band width threshold for strong trend
"""

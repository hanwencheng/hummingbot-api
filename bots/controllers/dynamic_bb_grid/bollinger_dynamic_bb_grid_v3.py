"""
Bollinger Bands Dynamic BB-Grid Strategy V3
...
When there is a strong breakthrough, the strategy will follow the trend rather than bet on the reverse direction.
...
Configurations
    ...
    bb_weak_threshold: The Bollinger Band width threshold for weak trend (do reverse order)
    bb_strong_threshold: The Bollinger Band width threshold for strong trend (do trend-following order)
"""

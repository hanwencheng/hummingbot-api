"""
Bollinger Bands Dynamic BB-Grid Strategy V5
...
The strategy will define standard stage, breakthrough stage and fallback stage according to the distance to bollinger band and the width of bollinger band.
...
class BollingerDynamicBBGridV5Config(DynamicBBGridControllerConfig):
    controller_name: str = "bollinger_dynamic_bb_grid_v5"


class BollingerDynamicBBGridV5Controller(DynamicBBGridController):
    """
    ...
    def __init__(self, config: BollingerDynamicBBGridV5Config, *args, **kwargs):
